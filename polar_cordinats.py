...
Note: complex() function can be used in python to convert the input
as a complex number.
...
Output Format
Output two lines:
The first line should contain the value of.The second line should contain the value of.
