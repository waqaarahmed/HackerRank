...
use split() to get the separate values in the form of a list. The delimiter is 
space (ascii 32) by default. To specify that comma is the delimiter, 
use string.split(','). For this challenge, and in general on HackerRank, space 
...
lists=sorted([*M_set.difference(N_set), *N_set.difference(M_set)])
print(*lists, sep='\n')
